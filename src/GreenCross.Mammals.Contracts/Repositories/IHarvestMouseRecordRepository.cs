...
public interface IHarvestMouseRecordRepository : IRepository<HarvestMouseRecord>
{
    ...
    Task<IEnumerable<HarvestMouseNestMonadExportDto>> GetNestCountByMonadAsync(CancellationToken cancellationToken = default);
    Task<IEnumerable<HarvestMouseNestLocationExportDto>> GetNestLocationAsync(CancellationToken cancellationToken = default);
}
